...
/***/ (function(module, exports, __webpack_require__) {
	...
	class Edit extends React.Component {
	  ...
	  render() {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement('input', { ref: 'textInput', className: 'form-control', type: 'text', value: this.state.value, onChange: this.handleChange, placeholder: 'input please' }),
	      React.createElement(
	        'div',
	        { className: 'text-left' },
	        React.createElement(
	        ...
	        React.createElement(
	          'select',
	          { 'class': 'form-control', ref: 'prioritySelect' },
	          React.createElement(
	            'option',
	            { value: '1' },
	            '\u6B63\u5E38'
	...
	class SortSelect extends React.Component {
	  ...
	  render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'select',
	        { 'class': 'form-control', ref: 'sortRule', onChange: this.taskSort },
	        React.createElement(
	          'option',
	...
	class ListItem extends React.Component {
	  ...
	  render() {
	    ...
	    if (this.props.complete === true) {
	      ...
	      task = React.createElement('input', { type: 'text', onChange: this.taskChange, value: task });
	    }
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        null,
	        React.createElement('input', { type: 'checkbox', className: 'pull-left', checked: itemChecked, onChange: this.toggleChange }),
	        task,
	        React.createElement(
	          'div',
	          { className: 'text-left' },
	        ...
	        React.createElement(
	          'button',
	          { className: 'btn btn-danger pull-right', onClick: this.deleteTask },
	          'delete'
	        )
	      )
	    );
	...
	class List extends React.Component {
	  render() {
	    return React.createElement(
	      ...
	      this.props.data.map(listItem => React.createElement(ListItem, {
	        task: listItem.task,
	        taskId: listItem.id,
	...
	class Main extends React.Component {
	  ...
	  init() {
	    axios.get('/list/api/msg/').then(res => {
	      this.setState({
	        data: res.data
	      });
	    });
	  ...
	  taskSort(flag) {
	    ...
	    axios.get('/list/api/msg-order/' + flag).then(res => {
	      this.setState({
	        data: res.data
	      });
	    });
	  ...
	  taskAdd(taskTemp, priority) {
	    ...
	    axios.post('/list/api/msg/', dataTemp).then(res => {
	      this.setState({
	  ...
	  taskRemove(taskId) {
	    axios.delete('/list/api/msg/' + taskId).then(res => {
	  ...
	  taskToggleComplete(taskId) {
	    ...
	    axios.put('/list/api/msg/' + taskId, item).then(res => {});
	  }
	  ...
	  taskChange(id, task) {
	    ...
	    console.log(task);
	    axios.put('/list/api/msg/' + id, item).then(res => {});
	  }
	  ...
	  render() {
	    return React.createElement(
	      ...
	      React.createElement(SortSelect, { taskSort: this.taskSort }),
